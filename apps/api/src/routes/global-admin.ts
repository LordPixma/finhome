...
// TEMPORARY DEBUG ENDPOINT - Remove after fixing global admin (no auth required)
app.post('/fix-database-user', async (c: AppContext) => {
  try {
...
// Apply global admin middleware to all routes except create-first-admin and fix-database-user
