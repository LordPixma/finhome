...
CREATE INDEX IF NOT EXISTS idx_bank_connections_provider ON bank_connections(provider, provider_connection_id);
...
CREATE INDEX IF NOT EXISTS idx_bank_accounts_provider ON bank_accounts(provider_account_id);
