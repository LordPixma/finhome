# Finhome360 — Bankless Edition (Nov 2025)

> Note: Live bank connections and automatic transaction sync are removed in this edition. Use manual entry and CSV/OFX file uploads. See Docs/DEPRECATIONS.md and Docs/CI_MIGRATIONS.md.
...
- **Bank Statement Import (Bankless)**: Upload and parse CSV/OFX files for transaction import
...
Removed tables in this edition (via migration 0005): bank_connections, bank_accounts, transaction_sync_history.
